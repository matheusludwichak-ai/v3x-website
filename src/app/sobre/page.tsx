        ...
        <div className="max-w-4xl mx-auto px-6 py-16 flex flex-col gap-12">
          ...
          <div className="grid grid-cols-3 gap-px bg-[#2A2A2A]">
            {[
              ...
              <div key={s.label} className="bg-[#0B0B0B] p-8 text-center">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <Link key={p.name} href={p.href} target="_blank" className="group border border-[#2A2A2A] bg-[#1A1A1A] hover:border-[#F5C242]/40 transition-colors p-6">
                  ...
                  <p className="text-xs text-[#F5C242] font-[family-name:var(--font-montserrat)] font-semibold mt-4">Conhecer →</p>
                </Link>
              ))}
            </div>
          </div>
