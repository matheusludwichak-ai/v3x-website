...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0B0B0B]">
      ...
      {/* Glow center */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-[#F5C242]/4 blur-[140px] pointer-events-none animate-pulse" style={{ animationDuration: "4s" }} />

      {/* Corner accents */}
      <div className="absolute top-24 left-0 w-32 h-px bg-gradient-to-r from-[#F5C242]/40 to-transparent" />
      <div className="absolute top-24 left-0 w-px h-32 bg-gradient-to-b from-[#F5C242]/40 to-transparent" />
      <div className="absolute top-24 right-0 w-32 h-px bg-gradient-to-l from-[#F5C242]/40 to-transparent" />
      <div className="absolute top-24 right-0 w-px h-32 bg-gradient-to-b from-[#F5C242]/40 to-transparent" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-24 pb-16">
        ...
        >
          <Link
            ...
            target="_blank"
            className="group w-full sm:w-auto font-[family-name:var(--font-montserrat)] font-semibold text-sm bg-[#F5C242] text-[#0B0B0B] px-8 py-4 hover:bg-white transition-all duration-200 hover:scale-[1.02] tracking-wide"
          >
          ...
          <Link
            href="#produtos"
            className="w-full sm:w-auto font-[family-name:var(--font-montserrat)] font-semibold text-sm border border-[#2A2A2A] text-[#F3F3F3] px-8 py-4 hover:border-[#F5C242] hover:text-white transition-all duration-200 tracking-wide"
          >
        ...
        {/* Stats */}
        <div
          className="mt-16 pt-8 border-t border-[#2A2A2A] grid grid-cols-3 gap-6 max-w-xl mx-auto"
        ...
        >
          {[
            ...
            <div key={s.label} className="text-center group cursor-default">
              ...
              <p className="text-xs text-[#F3F3F3]/40 font-[family-name:var(--font-inter)] mt-1">
                {s.label}
              </p>
            </div>
          ))}
