...
1. [Por que a gestão financeira é negligenciada](#por-que)
2. [Os 5 fundamentos financeiros](#fundamentos)
3. [Separação PF vs PJ](#separacao)
4. [Precificação correta](#precificacao)
5. [DRE: entendendo o resultado](#dre)
6. [Fluxo de caixa na prática](#fluxo-de-caixa)
7. [Indicadores financeiros essenciais](#indicadores)
8. [Gestão da inadimplência](#inadimplencia)
9. [Planejamento financeiro anual](#planejamento)
10. [FAQ](#faq)

---

## Por que a gestão financeira é negligenciada {#por-que}
...
## Os 5 fundamentos financeiros {#fundamentos}
...
## Precificação correta {#precificacao}
...
## DRE: entendendo o resultado {#dre}
...
## Fluxo de caixa na prática {#fluxo-de-caixa}
...
## Indicadores financeiros essenciais {#indicadores}
...
## Gestão da inadimplência {#inadimplencia}
...
## Planejamento financeiro anual {#planejamento}
